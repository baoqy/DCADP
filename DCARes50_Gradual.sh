...
CHECKPOINT_PATH="/share/home/fanxilai_lsec/SMSB/checkpoints/ResNet50-Dense.pth"
FIRST_EPOCH=91
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.run --nproc_per_node=2 run_experiment_gradual.py \
--arch resnet50 --dset imagenet --num_workers 12 \
...
--sparsity ${sparsity} --base_level 0.3 --dis_num 0 \
