...
python3 -u run_experiment_single.py --arch mlpnet --dset mnist --num_workers 2 \
--exp_name test --exp_id ${EXP_ID} --test_batch_size 256 \
...
--first_order_term False --sparsity 0.5 --base_level 0.3 \
--l2 ${l2} --sparsity_schedule ${sparsity_schedule} \
