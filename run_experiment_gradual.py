...
def set_all_seeds(seed):
    if isinstance(seed, list):  # 防止 seed 是 list
        seed = seed[0]

    seed = int(seed)  # 强制转换为整数
...
for seed,fisher_size, num_stages,num_iterations,sparsity,l2,sparsity_schedule,algo in product(args.seed, fisher_sizes,args.num_stages,args.num_iterations,args.sparsity,args.l2,args.sparsity_schedule,args.algo):
    
    
    print('seed,fisher_size, num_stages,num_iterations,sparsity,l2,sparsity_schedule,algo',seed,fisher_size, num_stages,num_iterations,sparsity,l2,sparsity_schedule,algo)
    ...
    'seed':seed,'fisher_mini_bsz':fisher_mini_bsz,
